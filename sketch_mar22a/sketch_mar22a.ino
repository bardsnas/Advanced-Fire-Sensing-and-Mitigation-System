/*
Filename: FinalProject_afsms.ino
Authors: Ken Do & Bardia Nasrulai
Date: 03/22/2025
Description:  This Arduino sketch implements an Advanced Fire Sensing and
              Mitigation System using ESP32, integrating multiple sensors
              and communication protocols. The system monitors fire risk by
              calculating the Fire Weather Index (FWI) using environmental data
              such as temperature, humidity, wind speed, and soil moisture levels.
*/
